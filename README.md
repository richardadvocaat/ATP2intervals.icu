...
**The last script ([NOTE_REMOVER.py](https://github.com/richardadvocaat/ATP2intervals.icu/blob/main/NOTE_REMOVER.py))** can be used to delete NOTES within a certain year and containing word. In case one of the scripts messed stuf up in intervals.icu. :-)
